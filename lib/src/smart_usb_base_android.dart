...
import 'package:smart_usb_android/src/common.dart';
import 'package:smart_usb_android/src/smart_usb_platform_interface.dart';

const MethodChannel _channel = MethodChannel('smart_usb');

class SmartUsbBaseAndroid extends SmartUsbPlatform {
  // For example/.dart_tool/flutter_build/generated_main.dart
  static registerWith() {
    SmartUsbPlatform.instance = SmartUsbBaseAndroid();
  }
